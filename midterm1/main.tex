...
\subsection*{Part e), Hartree-Fock.}
    ...
    \begin{align*}
        \hafo{h_{\lambda\gamma}} \equiv \inner{\lambda}{\hnull}{\gamma} + \sum_{\beta\delta} \rho_{\beta\gamma} \innerAS{\lambda\beta}{\hat{v}}{\gamma\delta},\hspace{20px}\rho_{\beta \gamma} \equiv \sum_i C^*_{i\beta} C_{i\gamma}
    \end{align*}
    Looking at equation \eqref{eq:HF_matrix_equation} we see that we have obtained an eigenvalue equation, where $\hafo{h}$ is our Hartree-Fock matrix, the columns of $C$ being eigenvectors corresponding to eigenvalue $\epsilon_t$. GIVE A SHORT OVERVIEW OF ALGO, DIAGRAMS, INTERPRETATION
...
\begin{table}[H]
    ...
    Atom      & $E_0$ & $E_{\text{CI}}$ & $E_{\text{HF}}$ & $E$ \\
    \hline
    Helium    & -2.7500     & -2.8385    &   -2.8311  & -2.9037    \\
    Beryllium & -13.7160     & -14.3621    &  -14.5083  &   -14.6674 
    \end{tabular}
    \caption{kld}
\end{table}
